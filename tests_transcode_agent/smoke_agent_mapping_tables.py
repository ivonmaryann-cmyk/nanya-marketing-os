...
def main() -> None:
    with TemporaryDirectory() as temp_dir_name:
        ...
        try:
            ...
            assert len(machine_rules) == 200, len(machine_rules)
            ...
            assert workbook["待接入规则"].max_row == 16
            ...
            print(
                ...
                "side=24 size=48 size_algo=1 thickness=2 material=2 external=1 pending=15"
            )
        finally:
